...
This is the python model for paperboard production from recycled paper (the
"finishing" archetype, NAICS 322130 - Paperboard mills, Recycling/finishing
...
Unit6.expected_flows_out = ['Formed paperboard', 'Wastewater (Forming and press)']
...
Unit7 = Unit('Yankee Dryer (paperboard)')
Unit7.expected_flows_in = ['Formed paperboard', 'Electricity (Yankee Dryer, paperboard)', 'Air (Yankee Dryer, paperboard)', 'Steam (Yankee Dryer, paperboard)']
Unit7.expected_flows_out = ['Dried paperboard', 'Exhaust gas (Yankee Dryer, paperboard)', 'Condensate (Yankee Dryer, paperboard)']


Unit7.coefficients = {'Dry paperboard moisture' : 0.05 , 'Air temperature' : 110, 'd_T' : 5, 'Exhaust gas temperature' : 100, 'Electricity (kWh) per ton of paper' : 21, 'Paperboard temperature' : 45, 'Loss' : 0.1}


def Dryerfunc_paperboard(paper_pulp_flow, coeff):
    ...
    dried_paper_out_t = coeff['Paperboard temperature']
    ...
    return [{'name' : 'Electricity (Yankee Dryer, paperboard)', 'components' : None, 'mass_flow_rate' : 0,
             'flow_type': 'Electricity', 'temperature' : 0,  'In or out' : 'In', 'elec_flow_rate' : electricity_amount ,  'Set calc' : False, 'Set shear' : False},
            {'name' : 'Air (Yankee Dryer, paperboard)', 'components' : ['Air'], 'composition': [1], 'mass_flow_rate' : m_air,
                     'flow_type': 'Air', 'temperature' : amb_t, 'pressure':1 , 'heat_flow_rate' :0 ,'In or out' : 'In', 'Set calc' : False, 'Set shear' : False},
            {'name' : 'Condensate (Yankee Dryer, paperboard)', 'components' : ['Water'], 'composition': [1], 'mass_flow_rate' : m_steam,
            ...
            {'name' : 'Steam (Yankee Dryer, paperboard)', 'components' : ['Water'], 'composition': [1], 'mass_flow_rate' : m_steam,
                     'flow_type': 'Steam', 'temperature' : steam_t, 'pressure':2.7 , 'heat_flow_rate' :Q_steam_in ,'In or out' : 'In', 'Set calc' : False, 'Set shear' : False},
            {'name' : 'Exhaust gas (Yankee Dryer, paperboard)', 'components' : ['Water', 'Air'], 'composition': [exhaust_gas_water_ratio, 1 - exhaust_gas_water_ratio], 'mass_flow_rate' : exhaust_amount,
...
Unit7.calculations = {'Formed paperboard' : Dryerfunc_paperboard}

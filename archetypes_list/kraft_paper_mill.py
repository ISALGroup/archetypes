...
This is the python model for Kraft paper mills. It can only be run with the 
...
Unit20.coefficients = {'Dry paper moisture' : 0.05 , 'Air temperature' : 80, 'd_T' : 5, 'Exhaust gas temperature' : 60, 'Electricity (kWh) per ton of paper' : 21, 'Paper temperature' : 45, 'Loss' : 0.1}

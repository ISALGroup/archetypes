...
This is the python model for beet sugar production. It can only be run with the 
...
For the present model, the author is Jason Ye. For any questions, please get
in touch: yejason366@gmail.com

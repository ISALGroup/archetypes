...
This is the python model for Sulfite paper mills. It can only be run with the 
...
Unit16= Unit('Dryer (paper)')
Unit16.expected_flows_in = ['Formed paper', 'Electricity (Dryer, paper)', 'Air (Dryer, paper)', 'Steam (Dryer, paper)']
Unit16.expected_flows_out = ['Dried paper', 'Exhaust gas (Dryer, paper)', 'Condensate (Dryer, paper)']

Unit16.coefficients = {'Dry paper moisture' : 0.05 , 'Air temperature' : 80, 'd_T' : 5, 'Exhaust gas temperature' : 60, 'Electricity (kWh) per ton of paper' : 21, 'Paper temperature' : 45, 'Loss' : 0.1}
...
Unit16.calculations = {'Formed paper' : Dryerfunc_paper}

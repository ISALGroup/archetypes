...
This is the python model for Ammonia manufacturing. It can only be run with the 
...
def Adiabatic_compressor_func(methane_flow, coeff):
    ...
    w = ((coeff['P_out'] * v_2) - (coeff['P_in'] * v_1)) / (1 - gamma_ch4)
...
# Unit 5: Secondary Reformer pt 1 
...
# Unit 6: Secondary Reformer pt 2 
...
# Unit 19: Ammonia Nitrate Process
...
# Unit 20: Ammonia Sulfate Preaheater
